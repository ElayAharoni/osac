...
export function demoOperatingModeLabel(role: 'providerAdmin' | 'tenantAdmin' | 'tenantUser'): string {
...
const NORTHSTAR_VMS: VmBlueprint[] = [
  { name: 'ns-banking-api-01', os: 'rhel', state: 'running', cores: 8, memoryGib: 32, subnet: 'prod-east-1a', ipAddress: '10.10.1.11', description: 'Banking API gateway' },
  { name: 'ns-banking-api-02', os: 'rhel', state: 'running', cores: 8, memoryGib: 32, subnet: 'prod-east-1a', ipAddress: '10.10.1.12', description: 'Banking API gateway (replica)' },
  { name: 'ns-db-primary', os: 'rhel', state: 'running', cores: 16, memoryGib: 64, subnet: 'db-east-1a', ipAddress: '10.10.2.10', description: 'PostgreSQL primary' },
  { name: 'ns-db-replica-01', os: 'rhel', state: 'running', cores: 16, memoryGib: 64, subnet: 'db-east-1b', ipAddress: '10.10.2.11', description: 'PostgreSQL read replica' },
  { name: 'ns-devops-jenkins', os: 'linux', state: 'running', cores: 4, memoryGib: 16, subnet: 'mgmt-east-1a', ipAddress: '10.10.3.5', description: 'CI/CD Jenkins' },
  { name: 'ns-compliance-scan', os: 'linux', state: 'running', cores: 2, memoryGib: 8, subnet: 'mgmt-east-1a', description: 'Compliance scanning workload' },
  { name: 'ns-web-frontend', os: 'linux', state: 'running', cores: 4, memoryGib: 8, subnet: 'prod-east-1b', ipAddress: '10.10.1.20', description: 'Customer portal frontend' },
  { name: 'ns-cache-redis', os: 'linux', state: 'running', cores: 2, memoryGib: 16, subnet: 'prod-east-1a', ipAddress: '10.10.1.30', description: 'Redis cache cluster' },
  { name: 'ns-analytics-01', os: 'linux', state: 'running', cores: 8, memoryGib: 32, subnet: 'analytics-east-1a', description: 'Analytics pipeline node 1' },
  { name: 'ns-analytics-02', os: 'linux', state: 'running', cores: 8, memoryGib: 32, subnet: 'analytics-east-1a', description: 'Analytics pipeline node 2' },
  { name: 'ns-monitoring', os: 'linux', state: 'running', cores: 4, memoryGib: 8, subnet: 'mgmt-east-1a', ipAddress: '10.10.3.10', description: 'Prometheus + Grafana' },
  { name: 'ns-fraud-detect', os: 'rhel', state: 'running', cores: 8, memoryGib: 32, subnet: 'prod-east-1a', description: 'Fraud detection ML inference' },
  { name: 'ns-dev-sandbox-01', os: 'linux', state: 'paused', cores: 4, memoryGib: 8, subnet: 'dev-east-1a', description: 'Dev sandbox A' },
  { name: 'ns-dev-sandbox-02', os: 'windows', state: 'paused', cores: 4, memoryGib: 16, subnet: 'dev-east-1a', description: 'Dev sandbox B (Windows)' },
  { name: 'ns-staging-api', os: 'rhel', state: 'paused', cores: 8, memoryGib: 32, subnet: 'staging-east-1a', description: 'Staging API' },
  { name: 'ns-legacy-reports', os: 'windows', state: 'stopped', cores: 2, memoryGib: 8, subnet: 'legacy-east-1a', description: 'Legacy reporting server' },
  { name: 'ns-archive-storage', os: 'linux', state: 'stopped', cores: 2, memoryGib: 4, subnet: 'archive-east-1a', description: 'Archive data processor' },
  { name: 'ns-test-env-01', os: 'linux', state: 'stopped', cores: 4, memoryGib: 8, subnet: 'dev-east-1a', description: 'Test environment VM' },
  { name: 'ns-test-env-02', os: 'rhel', state: 'stopped', cores: 4, memoryGib: 8, subnet: 'dev-east-1a', description: 'Test environment VM 2' },
  { name: 'ns-decom-batch', os: 'linux', state: 'stopped', cores: 2, memoryGib: 4, subnet: 'legacy-east-1a', description: 'Decommissioned batch processor' },
]

const EVERGREEN_VMS: VmBlueprint[] = [
  { name: 'eg-api-gateway', os: 'rhel', state: 'running', cores: 8, memoryGib: 32, subnet: 'prod-ca-1a', ipAddress: '192.168.1.10', description: 'API gateway' },
  { name: 'eg-core-banking', os: 'rhel', state: 'running', cores: 16, memoryGib: 64, subnet: 'prod-ca-1a', ipAddress: '192.168.1.11', description: 'Core banking service' },
  { name: 'eg-mobile-backend', os: 'linux', state: 'running', cores: 4, memoryGib: 16, subnet: 'prod-ca-1b', ipAddress: '192.168.1.20', description: 'Mobile banking backend' },
  { name: 'eg-db-postgres', os: 'rhel', state: 'running', cores: 8, memoryGib: 32, subnet: 'db-ca-1a', ipAddress: '192.168.2.10', description: 'PostgreSQL database' },
  { name: 'eg-monitoring', os: 'linux', state: 'running', cores: 2, memoryGib: 8, subnet: 'mgmt-ca-1a', ipAddress: '192.168.3.5', description: 'Monitoring stack' },
  { name: 'eg-pipeda-audit', os: 'linux', state: 'running', cores: 2, memoryGib: 8, subnet: 'compliance-ca-1a', description: 'PIPEDA audit log processor' },
  { name: 'eg-ml-risk', os: 'linux', state: 'running', cores: 8, memoryGib: 32, subnet: 'prod-ca-1a', description: 'ML risk scoring' },
  { name: 'eg-cdn-origin', os: 'linux', state: 'running', cores: 2, memoryGib: 4, subnet: 'prod-ca-1b', ipAddress: '192.168.1.30', description: 'CDN origin server' },
  { name: 'eg-dev-sandbox', os: 'linux', state: 'paused', cores: 4, memoryGib: 8, subnet: 'dev-ca-1a', description: 'Dev sandbox' },
  { name: 'eg-staging', os: 'rhel', state: 'stopped', cores: 8, memoryGib: 16, subnet: 'staging-ca-1a', description: 'Staging environment' },
  { name: 'eg-dr-replica', os: 'rhel', state: 'stopped', cores: 8, memoryGib: 32, subnet: 'dr-ca-1a', description: 'Disaster recovery replica' },
  { name: 'eg-legacy-payroll', os: 'windows', state: 'stopped', cores: 4, memoryGib: 8, subnet: 'legacy-ca-1a', description: 'Legacy payroll system' },
  { name: 'eg-test-01', os: 'linux', state: 'stopped', cores: 2, memoryGib: 4, subnet: 'dev-ca-1a', description: 'Test VM 1' },
]

function buildVm(
  blueprint: VmBlueprint,
  tenant: DemoTenantId,
  index: number,
): ComputeInstance {
...
export const NORTHSTAR_USERS: DemoUser[] = [
  { id: 'u-ns-1', name: 'Casey Morgan', email: 'cmorgan@northstarbank.com', role: 'tenantUser', status: 'active', lastLogin: '2 hours ago' },
  { id: 'u-ns-2', name: 'J. Lee', email: 'jlee@northstarbank.com', role: 'tenantAdmin', status: 'active', lastLogin: '1 hour ago' },
  { id: 'u-ns-3', name: 'Sarah Kim', email: 'skim@northstarbank.com', role: 'tenantUser', status: 'active', lastLogin: 'Yesterday' },
  { id: 'u-ns-4', name: 'David Park', email: 'dpark@northstarbank.com', role: 'tenantUser', status: 'active', lastLogin: '3 days ago' },
  { id: 'u-ns-5', name: 'Monica Reyes', email: 'mreyes@northstarbank.com', role: 'tenantUser', status: 'inactive', lastLogin: '2 weeks ago' },
]

export const EVERGREEN_USERS: DemoUser[] = [
  { id: 'u-eg-1', name: 'Priya Nair', email: 'priya.nair@bluestonefinancial.com', role: 'tenantUser', status: 'active', lastLogin: '30 minutes ago' },
  { id: 'u-eg-2', name: 'Marcus Chen', email: 'marcus.chen@bluestonefinancial.com', role: 'tenantAdmin', status: 'active', lastLogin: '1 hour ago' },
  { id: 'u-eg-3', name: 'Aisha Patel', email: 'aisha.patel@bluestonefinancial.com', role: 'tenantUser', status: 'active', lastLogin: 'Today' },
  { id: 'u-eg-4', name: 'Tom Laurent', email: 'tom.laurent@bluestonefinancial.com', role: 'tenantUser', status: 'inactive', lastLogin: '1 month ago' },
]
...
export function buildRecentActivities(vms: ComputeInstance[], count = 20): OsacEvent[] {
  ...
  return Array.from({ length: count }, (_, i) => {
    ...
    return {
      ...
      relatedObjectRefs: vm
        ? [{ kind: 'ComputeInstance', id: vm.id, name: vm.metadata.name }]
        : [],
    }
  })
}
